...
<html lang="en">
  ...
  <body>
    <img alt="my image" src="<c:url value="/resource/image/Google_doodle.png" />" >
    <div class="container">
     ...
     <input type="text" class="form-control" id="searchQuery" aria-describedby="emailHelp" name="searchQuery" placeholder="Enter search Query">
     </div>
